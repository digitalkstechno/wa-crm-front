        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative w-full md:w-auto">
            ...
            <input
              ...
              className="w-full md:w-auto pl-10 pr-4 py-2 bg-white border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 shadow-sm"
            />
          </div>
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="md:hidden divide-y divide-gray-50">
          {loading ? (
            ...
            <div key={customer._id} className="p-5 flex flex-col gap-4">
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="p-1.5 text-gray-400 hover:bg-gray-50 rounded-lg -mr-1.5"
                >
      ...
      <AnimatePresence>
        {isDrawerOpen && (
          <>
            ...
            <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'spring', damping: 25, stiffness: 200 }} className="fixed right-0 top-0 h-full w-full max-w-[480px] bg-white shadow-2xl z-[70] flex flex-col">
