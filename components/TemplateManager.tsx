...
export default function TemplateManager() {
  ...
  const handleDelete = async (id: string) => {
    ...
    if (previewId === id)
      setPreviewId(templates.find((t) => t._id !== id)?._id ?? null);
    setDeleteId(null);
            ...
            <div className="px-8 py-5 border-t border-gray-50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={page === 1}
                  className="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-100 rounded-xl hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
                >
                  ←
                </button>
                ...
                <div className="h-full bg-[#e5ddd5] flex flex-col">
                  ...
                  <div className="flex-1 p-3 overflow-y-auto">
                    <div className="bg-white rounded-2xl rounded-tl-none p-2.5 shadow-sm">
                      ...
                      <p className="text-[10px] text-gray-800 leading-relaxed whitespace-pre-wrap mt-1">
      ...
      <AnimatePresence>
        {openMenuId !== null && (
          ...
          >
            <button
              onClick={() => {
                const t = templates.find((t) => t._id === openMenuId);
                if (t) openEdit(t);
              }}
